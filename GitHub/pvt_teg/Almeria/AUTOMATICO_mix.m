...
% set_param('pvt_tegs_almeria', 'AlgebraicLoopSolver', 'Auto')

Ns = [16 8 4 2 1 32 16 8 4 2 1 48 24 16 12 8 6 4 3 2 1 64 32 16 8 4 2 1];
Np = [1 2 4 8 16 1 2 4 8 16 32 1 2 3 4 6 8 12 16 24 48 1 2 4 8 16 32 64];
...
for i=1:length(Ns)
    ...
    simOut(i)=sim("pvt_tegs_almeria.slx");
    T_sun = 5777; 
