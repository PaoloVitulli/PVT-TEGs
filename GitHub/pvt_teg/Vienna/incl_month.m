...
%a defined location, that is Vienna (Austria). 

%Vienna: 48.116573 N --->	48° 6' 59.663'' N
%Vienna: 16.532471 E --->	16° 31' 56.896'' E

l=48.116573; %Latitude [deg]
b=34.8; %Slope angle [deg]
...
t_jan=zeros(1,length(w)); %Angle of incidence of solar radiation [deg]
for i=1:length(w)
    t_jan(i)=incl(l,b,g,d_jan,w(i)); %Angle of incidence of solar radiation [rad]
end
t_jan_rad=deg2rad(t_jan);
